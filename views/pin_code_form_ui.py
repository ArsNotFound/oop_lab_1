...
class Ui_PinCodeForm(object):
    def setupUi(self, PinCodeForm):
        ...
        self.cat_image = QLabel(PinCodeForm)
        self.cat_image.setObjectName(u"cat_image")
        self.cat_image.setEnabled(True)
        sizePolicy2 = QSizePolicy(QSizePolicy.Maximum, QSizePolicy.Maximum)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.cat_image.sizePolicy().hasHeightForWidth())
        self.cat_image.setSizePolicy(sizePolicy2)
        self.cat_image.setPixmap(QPixmap(u":/img/assets/img/cat.jpg"))
        self.cat_image.setScaledContents(True)

        self.horizontalLayout.addWidget(self.cat_image)
